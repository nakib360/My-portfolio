  ...
  return (
    <div className="p-5 md:p-10">
      ...
      <motion.form
        ...
        className="max-w-xl mx-auto space-y-5 my-10"
      >
        {/* Name */}
        <motion.div variants={itemVariants} className="space-y-2">
          ...
          <div className="relative rounded-xl p-3 bg-blue-400/10">
            <input
              type="text"
              name="name"
              className="placeholder:text-xs placeholder:text-gray-400 focus:outline-none w-full text-xs"
        ...
        <motion.button
          ...
          className="cursor-pointer flex justify-center items-center text-sm bg-blue-600 p-4 rounded-xl w-full max-w-xl shadow-md hover:shadow-blue-500/60 hover:shadow-xl transition-shadow duration-300"
        >
          {pending ? (
            <div className="m-0.5 w-4 h-4 rounded-full border-2 border-white border-t-transparent animate-spin"></div>
          ) : (
            "Submit"
          )}
        </motion.button>
