...
export const BackgroundBeams = React.memo(({ className }) => {
  return (
    <div
      className={cn(
        // পুরো viewport ফিক্সড করে কভার করবে, স্ক্রল করলেও সরবে না
    ...
    >
      <svg
        aria-hidden="true"
        // key ফিক্স: h-full w-full এর বদলে অতিরিক্ত সাইজ দিয়ে center করা,
        // যাতে slice করার সময় beam অস্বাভাবিক মোটা/বড় না হয়
        className="absolute left-1/2 top-1/2 h-[120%] min-h-[800px] w-[120%] min-w-[1200px] -translate-x-1/2 -translate-y-1/2"
        fill="none"
        viewBox="0 0 696 316"
